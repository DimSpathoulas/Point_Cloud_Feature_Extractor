...
class CenterHead(nn.Module):
    def __init__(self, model_cfg, input_channels, num_class, class_names, grid_size, point_cloud_range, voxel_size,
        ...
        # print("curr_class", cur_class_id_mapping)
        ...
        #
        # print("shared_conv",self.shared_conv)
    ...
    def generate_predicted_boxes(self, batch_size, pred_dicts):
        ...
        for idx, pred_dict in enumerate(pred_dicts):
            ...
            batch_center = pred_dict['center']  # 2 * 128*128
    ...
    def forward(self, data_dict):
        ...
        if len(data_dict['final_box_dicts'][0]['pred_boxes']) == 0:  # if empty return empty
            ...
            xs = (xc - pcdr) / (featmapstride*voxel_size)
            ys = (yc - pcdr) / (featmapstride*voxel_size)
        ...
        for box_dict in data_dict['final_box_dicts']:
            box_dict['features'] = region_tensor
            box_dict['metadata'] = data_dict['metadata']  # comment out if you are running original demo
